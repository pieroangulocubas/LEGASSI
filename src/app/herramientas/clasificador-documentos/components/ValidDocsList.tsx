            ...
            {month.docs.map((doc) => {
              ...
              return (
                <div
                  ...
                  className="group w-full flex items-center gap-3 px-4 py-3 border-t border-border/60 hover:bg-muted/30 transition-colors text-left"
                >
                  {/* Clickable area */}
                  <button
                    type="button"
                  ...
                  {onDelete && (
                    <button
                      ...
                      className="shrink-0 rounded p-0.5 text-muted-foreground/30 hover:text-destructive hover:bg-destructive/10 transition-colors opacity-0 group-hover:opacity-100"
